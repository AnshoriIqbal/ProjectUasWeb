    ...
    <form action="{{(isset($Pengembalian))?route('pengembalian.update',$Pengembalian->id_pengembalian):route('pengembalian.store')}}" method="POST">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" value="{{(isset($Pengembalian))?$Pengembalian->id_karyawan:old('id_karyawan')}}" name="id_karyawan" class="form-control">
                ...
                <div class="col-lg-10">
                    <input type="text" value="{{(isset($Pengembalian))?$Pengembalian->tanggalPengembalian:old('tanggalPengembalian')}}" name="tanggalPengembalian" class="form-control">
